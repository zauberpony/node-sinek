...
export default class Drainer {
    ...
    private _messagesSinceLastDrain: number;
    private _receivedFirst: boolean;
    private _drainStart;
    private _stats: {};
    private _lastMessageHandlerRef: null;
    private DRAIN_INTV: number;
    private raw;

    constructor(private consumer = null, private asyncLimit = 1, private autoJsonParsing = true, private omitQueue = false, private commitOnDrain = false) {
