...
import {ConsumerGroup, Offset, Client, KafkaClient, HighLevelProducer, ConsumerGroupOptions} from "kafka-node";
...
export default class Kafka extends EventEmitter {
    ...
    private _autoCommitEnabled;
    private _isManual: boolean;
    public isProducer: boolean;
    public producer;
    private _producerReadyFired: boolean;
    private targetTopics: string[];

    constructor(private conString, private logger = null, private connectDirectlyToBroker = false) {
