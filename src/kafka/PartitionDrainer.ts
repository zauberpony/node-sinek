...
export default class PartitionDrainer {
    ...
    private _incomingSinceLastDrain: number;
    private _lastReceived: number;
    private _receivedFirst: boolean;
    private _drainStart;
    private _lastMessageHandlerRef;
    private _stats;
    private DRAIN_INTV: number;
    private _drainTargetTopic;
    private disablePauseResume: boolean;
    private _drainEvent;

    constructor(private consumer = null, private asyncLimit = 1, private commitOnDrain = false, private autoJsonParsing = true) {
